class ColorPallete
{
  ...
  public  void loadContent()
  {
    ...
    colorArray = new int[256];
    OLDcolorArray = new int[256];
    stringArrayToColorArray(colorStringArray, colorArray);
    stringArrayToColorArray(OLDcolorStringArray, OLDcolorArray);
  }

  private  void stringArrayToColorArray(String[] colorStringArray, int[] colorArray)
  {
    for (int i = 0; i < colorStringArray.length; i++)
    {

      String[] array = colorStringArray[i].split(",");
      colorArray[i] = color(Integer.parseInt(array[0]), Integer.parseInt(array[1]), Integer.parseInt(array[2]));
    }
  }
  ...
  {
    PVector one = new PVector(red(color1), green(color1), blue(color1));
    PVector two = new PVector(red(color2), green(color2), blue(color2));
    return one.dist(two);
  }
}
